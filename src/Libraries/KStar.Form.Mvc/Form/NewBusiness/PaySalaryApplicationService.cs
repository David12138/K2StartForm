...
{
    [KStarFormLogic("pay-salary-application")]
    internal class PaySalaryApplicationService : FormLogicBaseService, IFormLogicService
    {
        private KStar.Form.Domain.Service.NewBusiness.IPaySalaryApplicationService _applicationService { get; set; }

        public PaySalaryApplicationService(KStar.Form.Domain.Service.NewBusiness.IPaySalaryApplicationService applicationService)
        {
        ...
        public override void OnFormReSubmitAfter(KStarFormModel context)
        {
            ...
            _applicationService.AddAccountInfoHistory(model.TmpCollectionAccountInfo.Name, model.TmpCollectionAccountInfo.BankOfDeposit, model.TmpCollectionAccountInfo.Account);
        }
