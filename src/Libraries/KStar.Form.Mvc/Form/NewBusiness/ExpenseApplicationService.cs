...
{
    [KStarFormLogic("expense-application")]
    internal class ExpenseApplicationService : FormLogicBaseService, IFormLogicService
    {

        private KStar.Form.Domain.Service.NewBusiness.IExpenseApplicationService _applicationService { get; set; }
        public ExpenseApplicationService(KStar.Form.Domain.Service.NewBusiness.IExpenseApplicationService applicationService)
        {
