...
var headerToolbar = Vue.extend({
    ...
    props: ['formtype', 'formbtnmodel', 'formbackactivity', 'formoperationmodel', 'formesetting', 'procpredictionmodel', 'vmtime', 'switchvaluemodel'],
    data: function () {
        return {
            btnDisabled: false,
            parmdialog: {
        ...
        onlinePreview: function (item) {
            axios({
                ...
                if (preToken) {
                    ...
                    if (isMobile()) {
                        window.location.href = 'https://ypopen.countrygarden.com.cn/preview/preview.html?preview_token=' + preToken;
                    }
                    else {
